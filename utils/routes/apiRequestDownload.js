...
export async function fetchSalas(adicionarSalasnoHtmlMedio, adicionarSalasnoHtmlFundamental, salasEnsinoMedio, salasEnsinoFundamental, adicionarEtiquetasEnsino, exibirMensagemBancoVazio) {
    try {
        ...
        // Verifica se a resposta é um array e se está vazio
        if (Array.isArray(response) && response.length === 0) {
            console.log("Banco vazio!");
            exibirMensagemBancoVazio();  // Exibe a mensagem caso o banco esteja vazio
            return;
        }

        // Apenas adiciona as salas no frontend sem limpar as listas anteriores
